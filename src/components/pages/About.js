      ...
      <div className="menuCont d-flex">
        <div className="card menuBack meB">
          ...
          <ul className="menuUL">
            ...
            >STRAWBERRY</motion.li>
            <motion.li
            initial={{ y: -1000}} 
            animate={{y: 0}}
             transition={{ delay: 0.7 , type: 'tween'}}>CHERRY</motion.li>
            <motion.li
            initial={{ y: -1000}} 
            animate={{y: 0}}
             transition={{ delay: 0.9 , type: 'tween'}}>PINA COLADA</motion.li>
             <motion.li
            initial={{ y: -1000}} 
            animate={{y: 0}}
             transition={{ delay: 1.1 , type: 'tween'}}>PINEAPPLE</motion.li>
             <motion.li
            initial={{ y: -1000}} 
            animate={{y: 0}}
             transition={{ delay: 1.3 , type: 'tween'}}>COTTON CANDY</motion.li>
             <motion.li
            initial={{ y: -1000}} 
            animate={{y: 0}}
             transition={{ delay: 1.5 , type: 'tween'}}>BLUE BUBBLEGUM</motion.li>
          </ul>
        </div>
        ...
        <motion.div
          ...
          <motion.li
            initial={{ y: 3000}} 
            animate={{y: 0}}
             transition={{ delay: 1.7 , type: 'tween'}}>BLUE RASPBERRY</motion.li>
            <motion.li
            initial={{ y: 3000}} 
            animate={{y: 0}}
             transition={{ delay: 1.9 , type: 'tween'}}>STRAWBERRY</motion.li>
            <motion.li
            initial={{ y: 3000}} 
            animate={{y: 0}}
             transition={{ delay: 2.1 , type: 'tween'}}>WATERMELON</motion.li>
            <motion.li
            initial={{ y: 3000}} 
            animate={{y: 0}}
             transition={{ delay: 2.3 , type: 'tween'}}>GREEN APPLE</motion.li>
            <motion.li
            initial={{ y: 3000}} 
            animate={{y: 0}}
             transition={{ delay: 2.5 , type: 'tween'}}>COTTON CANDY</motion.li>
            <motion.li
            initial={{ y: 3000}} 
            animate={{y: 0}}
             transition={{ delay: 2.7 , type: 'tween'}}>JOLLY RANCHER GRAPE</motion.li>
          </ul>
        </div>
        <div className="card menuBack ">
